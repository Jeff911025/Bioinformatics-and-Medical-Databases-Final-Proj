...
- Shelter(收容所)
  ...
  ++shelter_name++(動物所屬收容所名稱)、album_file(圖片名稱)、album_update(異動時間)、cDate(資料更新時間)、shelter_address(地址)、shelter_tel(連絡電話)

- Adopter(領養者)

  ++adopter_id++、adopter_name、adopter_phone、adopter_email、adopter_city、adopter_age、adopter_house_type
